...
void main() {
	...
	if(maxLength >= 32)
		throw new Exception("increase the size of the `entityBeingTried` buffer in dom.d to " ~ to!string(maxLength + 1) ~ " and also the maxLength in this program to match. Longest: " ~ longest);
